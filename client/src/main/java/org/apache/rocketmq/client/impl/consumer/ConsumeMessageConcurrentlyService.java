...
public class ConsumeMessageConcurrentlyService implements ConsumeMessageService {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    ...
                    BlockingQueue<Runnable> queue = consumeExecutor.getQueue();
                    System.out.println("消费者目前队列中的队列数=" + consumeRequestQueue.size() + ",LinkedBlockingQueue=" + queue);
                }
            }
    ...
    public void start() {
        this.cleanExpireMsgExecutors.scheduleAtFixedRate(new Runnable() {
            ...
            @Override
            public void run() {
                System.out.println("线程[" + Thread.currentThread().getName() + "]开始执行清除");
                cleanExpireMsg();
            }
    ...
    class ConsumeRequest implements Runnable {
        ...
        public void run() {
            ...
            } else if (consumeRT >= defaultMQPushConsumer.getConsumeTimeout() * 60 * 1000) { // 15分钟
